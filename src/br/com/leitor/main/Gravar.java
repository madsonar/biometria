...
//        setIconImage(new ImageIcon(getClass().getResource("/resources/images/finger.png")).getImage());
//        add(barra);
//        add(btnLeitura);
//        // add(jPanel);
//    }
...
//    }
//
//    public void gravarBiometria() {
//        Dao dao = new Dao();
//        Biometria b = (Biometria) dao.find(new Biometria(), 1);
//        if (b == null) {
//            b = new Biometria();
//            b.setPessoa((Pessoa) dao.find(new Pessoa(), 1));
//        }
